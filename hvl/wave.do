...
add wave -noupdate -group arbiter /mp4_tb/dut/arbiter/i_connected
add wave -noupdate -group arbiter /mp4_tb/dut/arbiter/lsq_connected
...
add wave -noupdate -expand -group pc_reg /mp4_tb/dut/cpu/lazy_br
add wave -noupdate -expand -group pc_reg /mp4_tb/dut/cpu/br_stall
add wave -noupdate -expand -group pc_reg /mp4_tb/dut/cpu/iq_br
add wave -noupdate -expand -group pc_reg /mp4_tb/dut/cpu/iq_stall
add wave -noupdate -expand -group pc_reg /mp4_tb/dut/cpu/rob_finish_br
...
add wave -noupdate -group rob /mp4_tb/dut/cpu/rob/arr
add wave -noupdate -group rob /mp4_tb/dut/cpu/rob/rob_front
add wave -noupdate -group rob /mp4_tb/dut/cpu/rob/instr_q_dequeue
add wave -noupdate -group rob /mp4_tb/dut/cpu/rob/instr_q_empty
add wave -noupdate -group rob /mp4_tb/dut/cpu/rob/pci
add wave -noupdate -group rob /mp4_tb/dut/cpu/rob/stall_br
add wave -noupdate -group rob /mp4_tb/dut/cpu/rob/stall_lsq
add wave -noupdate -group rob /mp4_tb/dut/cpu/rob/stall_acu
add wave -noupdate -group rob /mp4_tb/dut/cpu/rob/acu_rs_o
add wave -noupdate -group rob /mp4_tb/dut/cpu/rob/br_rs_o
add wave -noupdate -group rob /mp4_tb/dut/cpu/rob/lsq_o
add wave -noupdate -group rob /mp4_tb/dut/cpu/rob/load_br_rs
add wave -noupdate -group rob /mp4_tb/dut/cpu/rob/load_lsq
add wave -noupdate -group rob /mp4_tb/dut/cpu/rob/rob_broadcast_bus
add wave -noupdate -group rob /mp4_tb/dut/cpu/rob/rdest
add wave -noupdate -group rob /mp4_tb/dut/cpu/rob/rd_tag
add wave -noupdate -group rob /mp4_tb/dut/cpu/rob/temp_in
add wave -noupdate -group rob /mp4_tb/dut/cpu/rob/front
add wave -noupdate -group rob /mp4_tb/dut/cpu/rob/rear
add wave -noupdate -group rob /mp4_tb/dut/cpu/rob/enq
add wave -noupdate -group rob /mp4_tb/dut/cpu/rob/deq
add wave -noupdate -group rob /mp4_tb/dut/cpu/rob/full
add wave -noupdate -group rob /mp4_tb/dut/cpu/rob/empty
...
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/rob_bus
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/reg_entry
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/instruction
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/rob_tag
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/lsq_stall
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/lsq_out
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/mem_resp
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/mem_rdata
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/mem_read
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/mem_write
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/mem_byte_enable
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/mem_address
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/mem_wdata
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/front_is_ld
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/remainder
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/shift_amt
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/mem_address_raw
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/mem_rdata_shifted
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/lsq_enq
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/lsq_deq
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/lsq_empty
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/lsq_full
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/lsq_ready
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/is_lsq_instr
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/is_ld_instr
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/is_st_instr
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/lsq_in
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/lsq_front
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/arr
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/ld_byte_en
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/enq
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/deq
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/in
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/empty
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/full
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/ready
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/out
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/front
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/rear
add wave -noupdate -group lsq /mp4_tb/dut/cpu/lsq/front_is_valid
...
add wave -noupdate -group acu_rs -expand /mp4_tb/dut/cpu/acu_rs/data
...
WaveRestoreCursors {{Cursor 1} {736740 ps} 0}
