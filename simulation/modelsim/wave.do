...
add wave -noupdate -group reg_file /mp4_tb/dut/cpu/registers/reg_ld_instr1
add wave -noupdate -group reg_file /mp4_tb/dut/cpu/registers/rd_tag1
add wave -noupdate -group reg_file /mp4_tb/dut/cpu/registers/rs11
add wave -noupdate -group reg_file /mp4_tb/dut/cpu/registers/rs21
add wave -noupdate -group reg_file /mp4_tb/dut/cpu/registers/rd1
add wave -noupdate -group reg_file /mp4_tb/dut/cpu/registers/flush
add wave -noupdate -group reg_file /mp4_tb/dut/cpu/registers/rs_out1
add wave -noupdate -group reg_file /mp4_tb/dut/cpu/registers/temp
