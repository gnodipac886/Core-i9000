...
add wave -noupdate -group rob -group rob_unimm -expand /mp4_tb/dut/cpu/rob/rdest
...
WaveRestoreCursors {{Cursor 1} {5310685 ps} 0}
...
update
WaveRestoreZoom {2012500 ps} {7262500 ps}
